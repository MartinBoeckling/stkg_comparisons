...
def kg_creation(spark_master: str, spark_driver_memory: str, spark_executor_memory: str, spark_temp_directory: str,
                geometry_file_path: str, grid_parquet_path: str, grid_compaction: bool, grid_level: int, kg_output_path: str) -> None:
    """
    ...
    spark = configure_spark_with_delta_pip(builder, extra_packages=['org.apache.sedona:sedona-spark-shaded-3.5_2.12:1.5.1,'
                   'org.datasyslab:geotools-wrapper:1.5.1-28.2']).getOrCreate()
    ...
    osm_key_value = spark.read.format("parquet").load("data_preparation/stkg/helper/osm_main_tags.parquet")
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Knowledge graph creation argument parser')
    kg_output_path: str
    ...
    kg_creation(spark_master=args.spark_master, spark_driver_memory=args.spark_driver_memory, spark_executor_memory=args.spark_executor_memory,
                spark_temp_directory=args.spark_temp_directory, geometry_file_path=args.geometry_file_path, grid_parquet_path=args.grid_parquet_path,
                grid_compaction=args.grid_compaction, grid_level=args.grid_level, kg_output_path=args.kg_output_path)
